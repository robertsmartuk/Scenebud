...
<header className="bg-white">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <h1 className="text-2xl font-bold text-purple-700">Manage Promoters</h1>
          <a 
            href="/promotersubmit" 
        ...
        <div className="space-y-6">
          ...
          <div className="hidden">
            <div className="text-center py-12 border-2 border-dashed rounded-lg">
              ...
              <h2 className="text-lg font-medium text-gray-900 mb-1">No promoter profiles yet</h2>
              <p className="text-gray-600 mb-4">Create your first promoter profile to start managing them here</p>
              <a 
                href="#" 
          ...
          {/* Promoter Profiles */}
          {[1, 2, 3].map((promoter) => (
            <div key={promoter} className="bg-white rounded-lg border border-gray-200 p-6">
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-start">
                    <div>
                      <h2 className="text-xl font-semibold text-purple-700 mb-1">Event Horizon Promotions</h2>
                      <div className="flex items-center gap-2 text-gray-600 mb-2">
                        <MapPin className="w-4 h-4" />
                        <span>London, UK</span>
                      </div>
                      <p className="text-gray-800">London's premier electronic music promoter</p>
                    </div>
                    <div className="flex items-center gap-4">
                      <span className="text-gray-600">4.2k followers</span>
                      <a 
                        href="promotermanage" 
                        className="flex items-center gap-2 px-4 py-2 border border-purple-700 text-purple-700 rounded-lg hover:bg-purple-700 hover:text-white"
                      >
                  ...
                  <div className="mt-4 flex gap-8 text-sm text-gray-600">
                    <div>
                      <span className="font-medium">Active Events:</span> 8
                    </div>
                    <div>
                      <span className="font-medium">Past Events:</span> 45
                    </div>
                    <div>
                  ...
                  <div className="mt-6 pt-6 border-t border-gray-200 flex justify-between items-center">
                    <div className="flex gap-4">
                      <a href="/promoterprofile" className="text-purple-700 hover:underline">View Public Profile</a>
                    ...
                    <a href="/promoterprofile" className="text-purple-700 hover:underline flex items-center gap-1">
                      View All Details
...
export default ManagePromoters;