...
<header className="bg-white">
      ...
      <div className="max-w-3xl mx-auto px-4 py-12">
        ...
        <h1 className="text-2xl font-bold text-purple-700 mb-8">Create Artist Profile</h1>
        ...
        <form className="space-y-8">
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="e.g. Politically motivated Jazz Fusion from Leeds"
                className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:border-purple-700 focus:ring-1 focus:ring-purple-700"
                required
              />
            </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <div>
              ...
              <input
                type="text"
                placeholder="Add your musical influences"
                className="w-full px-4 py-2 border border-gray-200 rounded-lg focus:border-purple-700 focus:ring-1 focus:ring-purple-700"
              />
